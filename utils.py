...
def get_trainpath(source_path):
  ...
  elif source_path == 'sample':
      source_data_path = mydata.sample_data_path
      source_train_set = mydata.sample_train_set
      source_test_set = mydata.sample_test_set
...
def get_testpath(target_path):
  ...
  elif target_path == 'sample':
      target_data_path = mydata.sample_data_path
      target_train_set = mydata.sample_train_set
      target_test_set = mydata.sample_test_set
...
def plot_train_loss(rundir,loss_target, loss_stepA, loss_stepB, loss_stepC, epoch):
  plt.figure(figsize = (16,16))
  name='loss iteration'
  plt.title(name)
  plt.plot(loss_target, label='loss_target')
  plt.plot(loss_stepA, label='loss_stepA')
  plt.plot(loss_stepB, label='loss_stepB')
  plt.plot(loss_stepC, label='loss_stepC')
  plt.xlabel('epoch')
